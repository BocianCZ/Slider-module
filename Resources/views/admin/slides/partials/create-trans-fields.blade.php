...
<div class="form-group">
    ...
    <div class='input-group{{ $errors->has("{$lang}[uri]") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("{$lang}[uri]", old("{$lang}[uri]"), ['class' => 'form-control', 'placeholder' => trans('slider::slider.form.uri')]) !!}
...
<div class="form-group{{ $errors->has("{$lang}[url]") ? ' has-error' : '' }}">
    ...
    {!! Form::text("{$lang}[url]", old("{$lang}[url]"), ['class' => 'form-control', 'placeholder' => trans('slider::slider.form.url')]) !!}

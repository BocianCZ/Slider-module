...
<ol class="breadcrumb">
    ...
    <li><a href="{{ URL::route('dashboard.slide.index', $slider->id) }}">{{ trans('slider::sliders.breadcrumb.slider') }}</a></li>
...
@section('content')
{!! Form::open(['route' => ['dashboard.slide.store', $slider->id], 'method' => 'post']) !!}
<div class="row">
    <div class="col-md-12">

...
<ol class="breadcrumb">
    ...
    <li><a href="{{ URL::route('admin.slider.slider.index') }}">{{ trans('slider::sliders.breadcrumb.slider') }}</a></li>
...
@section('content')
{!! Form::open(['route' => ['dashboard.slide.update', $slider->id, $slide->id], 'method' => 'put']) !!}
<div class="row">
    <div class="col-md-12">

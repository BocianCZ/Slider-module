<div class='form-group{{ $errors->has('name') ? ' has-error' : '' }}'>
    ...
    {!! Form::text('name', Input::old('name'), ['class' => 'form-control', 'placeholder' => trans('slider::slider.form.name')]) !!}
...
<div class='form-group{{ $errors->has('system_name') ? ' has-error' : '' }}'>
    ...
    {!! Form::text('system_name', Input::old('system_name'), ['class' => 'form-control', 'placeholder' => trans('slider::slider.form.system name')]) !!}
